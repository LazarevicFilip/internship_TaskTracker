...
namespace DataAccess.DAL.Migrations
{
    ...
    [Migration("20230424160530_Add refresh token support")]
            ...
            modelBuilder.Entity("DataAccess.DAL.Core.ProjectModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CompletionDate = new DateTime(2023, 8, 24, 16, 5, 30, 785, DateTimeKind.Utc).AddTicks(5905),
                            CreatedAt = new DateTime(2023, 4, 24, 16, 5, 30, 785, DateTimeKind.Utc).AddTicks(5904),
                            IsActive = false,
                            Name = "Project from seeder.",
                            ProjectPriority = 3,
                            ProjectStatus = 0,
                            StartDate = new DateTime(2023, 4, 24, 16, 5, 30, 785, DateTimeKind.Utc).AddTicks(5905)
                        });
                });
