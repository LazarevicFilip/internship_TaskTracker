...
namespace DataAccess.DAL.Migrations
{
    ...
    [Migration("20230308172418_Added indexes in project table")]
    partial class Addedindexesinprojecttable
    {
            ...
            modelBuilder.Entity("DataAccess.DAL.Core.ProjectModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CompletionDate = new DateTime(2023, 7, 8, 17, 24, 18, 445, DateTimeKind.Utc).AddTicks(51),
                            CreatedAt = new DateTime(2023, 3, 8, 17, 24, 18, 445, DateTimeKind.Utc).AddTicks(49),
                            IsActive = false,
                            Name = "Project from seeder.",
                            ProjectPriority = 3,
                            ProjectStatus = 0,
                            StartDate = new DateTime(2023, 3, 8, 17, 24, 18, 445, DateTimeKind.Utc).AddTicks(51)
                        });
                });
